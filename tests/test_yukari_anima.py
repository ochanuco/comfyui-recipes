...
COFFEE_POSITIVE = (
    ...
    "vocaloid, voiceroid, (@ixy:0.7), light purple hair, short hair with "
    "long locks, very long sidelocks, purple eyes, hair ornament, "
    "(drinking:1.3), (iced coffee:1.4), (plastic cup:1.45), (clear cup:1.2), "
    "(drinking straw:1.4), (holding cup:1.35), (straw in mouth:1.25), "
    "(unamused:1.3), (half-closed eyes:1.3), (looking at viewer:1.1), "
    ...
    "(standing:1.2), (cowboy shot:1.3), (thighs:1.2), (wide hips:1.4), "
    "(thick thighs:1.4), (plump thighs:1.2), (curvy:1.15), "
    "(narrow waist:1.2), simple background, grey background, "
    "(large eyes:1.4), (round face:1.3), (tareme:1.2), "
    "(thick eyelashes:1.3), (flat color:1.7), (anime coloring:1.4), "
    "(cel shading:1.2), (limited palette:1.6), (few colors:1.3), "
    "(matte:1.5), (minimal shading:1.2), (flat shadow:1.2), "
    "(thin lineart:1.3), (simple lines:1.3), (minimal lines:1.2), "
    "(black lineart:1.35), (black outline:1.2)"
)
...
COFFEE_NEGATIVE = (
    ...
    "(glitter:1.3), (multiple highlights:1.3), (gradient eyes:1.2), "
    "(speed lines:1.45), (motion lines:1.4), (emphasis lines:1.4), "
    "(hood:1.3), (cardigan:1.3), score_1, score_2, score_3"
)
...
AMAE_POSITIVE = (
    ...
    "vocaloid, voiceroid, (@ixy:0.7), light purple hair, short hair with "
    "long locks, very long sidelocks, purple eyes, hair ornament, "
    "(smug:1.35), (doyagao:1.25), (pleading:1.15), (tareme:1.3), "
    ...
    "(white sweatshirt:1.2), (sleeves past wrists:1.25), "
...
class RenderSpecTest(unittest.TestCase):
    def test_render_spec_fields(self):
        ...
        self.assertEqual((spec.width, spec.height), (1536, 1920))
